// JS code for visualization of on-road bicycle facility data.
...
d3.queue()
  ...
  .defer(d3.csv, "../../data/csv/on_road_bike_faciliites_2011_97towns.csv")
  .defer(d3.csv, "../../data/csv/on_road_bike_facilities_2016_97towns.csv")
