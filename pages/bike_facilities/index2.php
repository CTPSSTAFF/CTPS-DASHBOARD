...
<div id="header" class="col-md-10 col-md-offset-1">
	...
	<p>The map of Boston region municipalities below illustrates the miles of existing off-road bicycle facilities (shared-use paths) per centerline mile
       of roadway in each municipality as of 2016. 
	   Hover over a city or town on the map to view the total miles of off-road bicycle facilities that were in the municipality in 2011 and 2016. 
	   The bar graph also depicts the miles of off-road bicycle facilities in each municipality and a comparison of the 2011 and 2016 data.
	</p>
	...
	<h3> Current and Future State of Off-Road Bicycle Facilities (as of 2016)</h3>
	
	<p>The map of the Boston region municipalities below documents the status of off-road bicycle facilities (shared-use paths) in
       each municipality as of 2016. 
	   ...
	   To the right of this map, the middle bar graph illustrates the percentage of off-road bicycle facilities in every Boston region municipality
	   that is made up of each bicycle facility category. 
	   The bar graph to the far right depicts the total off-road mileage of each bicycle facility category in every municipality.
	</p>
