...
CTPS.demoApp.generateMap = function(mpoTowns, crashdata) {	
	...
	var tip = d3.tip()
	  ...
	  .html(function(d) {
	    ...
	    return "<p>" + town + "</p><b>2019 Statistics</b><br>Motorized Injuries: " + f(findIndex(town, "mot_inj")) + "<br>Motorized Fatalities: " + findIndex(town, "mot_fat") + 
