...
d3.queue()
	...
	.defer(d3.json, "../../data/json/CTPS_CMP_2014_ART_ROUTES_postgresql.topo.json")
...
CTPS.demoApp.generateMap = function(cities, arterials, route_ids) {	
	...
	var arterialRoads = topojson.feature(arterials, arterials.objects.CTPS_CMP_2014_ART_ROUTES_postgresql).features;
