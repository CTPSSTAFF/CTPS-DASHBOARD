...
CTPS_CMP_2014_ART_ROUTES_postgresql_NO_ATTRS.topo.json | Geometry of arterial routes in MPO region. No performance attributes. | __Can be deleted.__
CTPS_CMP_2015_ART_ROUTES_EXT_augmented2.geo.json | First (sic) version of Geometry and performance attributes of arterial routes in MPO region. | No longer used. __Can be deleted.__
CTPS_CMP_2015_ART_ROUTES_EXT_augmented_v3.geo.json | Second (sic) version of Geometry and performance attributes of arterial routes in MPO region. | No longer used. __Can be deleted.__
CTPS_CMP_2015_ART_ROUTES_EXT_augmented_v4.geo.json | Third (sic) version of Geometry and performance attributes of arterial routes in MPO region. | No longer used. __Can be deleted.__
CTPS_CMP_2015_ART_ROUTES_EXT_augmented_v5.geo.json | Fourth (sic) and FINAL version of Geometry and performance attributes of arterial routes in MPO region. | __LIVE VERSION__
...
CTPS_CMP_2019_EXP_ROUTES_postgresql.geo.json | Geometry and 2019 performance attributes of express routes in MPO region in GeoJSON format; this data was extracted from an ArcGIS feature class backed by an PostgreSQL database, and has attribute (property) names in __lowercase__. | __Can be deleted.__
CTPS_CMP_2019_EXP_ROUTES_dashboard_v1.geo.json | First cut at production verison of geometry and 2019 performance attributes of express routes in MPO region in GeoJSON format.
CTPS_CMP_2019_EXP_ROUTES_dashboard_v2.geo.json | FINAL production version of geometry and 2019 performance attributes of express routes in MPO region in GeoJSON format. |  _LIVE VERSION__
